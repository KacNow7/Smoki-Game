import { type Card, type ClientGameState, type MirrorDirection, type Player, type RoomState, type RoundResult } from './types.js';
...
export declare function buildAutoMirrorChoices(room: RoomState, player: Player): Record<number, MirrorDirection>;
