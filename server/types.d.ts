...
export type TurnPhase = 'WAITING_FOR_PLAYERS' | 'CHOOSE_INITIAL_REVEAL' | 'CHOOSE_DRAW_SOURCE' | 'CHOOSE_KEEP_OR_DISCARD' | 'CHOOSE_REPLACE_SLOT' | 'CHOOSE_NEST_SWAP' | 'ROUND_SCORING' | 'ROUND_RESULTS' | 'GAME_OVER';
